...
//import br.com.techchallenge.fiap.process.core.usecase.processamento.acompanhachain.status.anemic.AcompanhamentoChainRecebido;
//import br.com.techchallenge.fiap.process.infrastructure.gateways.ProcessamentoRepositorioGateway;
//import br.com.techchallenge.fiap.process.infrastructure.persistence.acompanhamento.DocumentRepository;
//import br.com.techchallenge.fiap.process.infrastructure.persistence.acesso.PedidoRepository;
//import br.com.techchallenge.fiap.process.infrastructure.persistence.acesso.entities.ItemEntity;
//import br.com.techchallenge.fiap.process.infrastructure.persistence.acesso.entities.PedidoEntity;
...
//
//    @Autowired
//    private ProcessamentoRepositorioGateway repositorioGateway;
//
...
//
//        /* ACT */
//        processamentoGateway = new ProcessamentoRepositorioGateway(documentRepository, pedidoRepository);
//        AcompanhamentoResponseDTO orderStatus = processamentoGateway.getOrderStatus(pedido.getId());
//
//        /* ASSERT */
...
//                "\n";
//
//        chainRecebido = new AcompanhamentoChainRecebido(processamentoGateway);
//
//        /* ACT */
